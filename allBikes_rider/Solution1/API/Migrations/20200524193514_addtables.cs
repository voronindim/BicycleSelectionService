        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarCapacity = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bikes_Attachments_AttachmentId",
                        column: x => x.AttachmentId,
                        principalTable: "Attachments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bikes_Specifications_SpecificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bikes_AttachmentId",
                table: "Bikes",
                column: "AttachmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Bikes_SpecificationId",
                table: "Bikes",
